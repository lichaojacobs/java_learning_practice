...
public class BoundedPriorityBlockingQueue<E> extends PriorityBlockingQueue<E> {
    ...
    public boolean offer(final E e) {
        try {
            LOG.warn(String.format("offer begin: %s", e));
            ...
            // high value with low priority element, should reject
            ...
            decrease();
            LOG.warn(String.format("remove oldest element"));
            increase(e);
            return true;
    ...
    private void decrease() throws InvocationTargetException, IllegalAccessException {
        ...
        this.removeLastElem.invoke(priorityBlockingQueue, priorityBlockingQueue.size() - 1);
    }
