package com.example.basic.akka.router;

import com.example.basic.akka.MyWorker;
...
public class WatchRouteActor extends UntypedActor {
  ...
  public void onReceive(Object msg) throws Throwable {
    if (msg instanceof MyWorker.Msg) {
      ...
      System.out.println(((Terminated) msg).actor()
          .path() + " is closed, routees=" + router.routees()
          .size());
      if (router.routees()
          .size() == 0) {
